...
class Chrancestries(models.Model):
    ...
    ancestryname = models.CharField(max_length=100L, db_column='ancestryName', blank=True) # Field name made lowercase.
    ...
    shortdescription = models.CharField(max_length=500L, db_column='shortDescription', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Chrattributes(models.Model):
    ...
    attributename = models.CharField(max_length=100L, db_column='attributeName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    shortdescription = models.CharField(max_length=500L, db_column='shortDescription', blank=True) # Field name made lowercase.
    notes = models.CharField(max_length=500L, blank=True)
    class Meta:
        managed = False
...
class Chrbloodlines(models.Model):
    ...
    bloodlinename = models.CharField(max_length=100L, db_column='bloodlineName', blank=True) # Field name made lowercase.
    raceid = models.IntegerField(null=True, db_column='raceID', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    maledescription = models.CharField(max_length=1000L, db_column='maleDescription', blank=True) # Field name made lowercase.
    femaledescription = models.CharField(max_length=1000L, db_column='femaleDescription', blank=True) # Field name made lowercase.
    ...
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    shortdescription = models.CharField(max_length=500L, db_column='shortDescription', blank=True) # Field name made lowercase.
    shortmaledescription = models.CharField(max_length=500L, db_column='shortMaleDescription', blank=True) # Field name made lowercase.
    shortfemaledescription = models.CharField(max_length=500L, db_column='shortFemaleDescription', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Chrfactions(models.Model):
    ...
    factionname = models.CharField(max_length=100L, db_column='factionName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
...
class Chrraces(models.Model):
    ...
    racename = models.CharField(max_length=100L, db_column='raceName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    shortdescription = models.CharField(max_length=500L, db_column='shortDescription', blank=True) # Field name made lowercase.
    class Meta:
...
class Crpactivities(models.Model):
    ...
    activityname = models.CharField(max_length=100L, db_column='activityName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    class Meta:
        managed = False
...
class Crpnpccorporations(models.Model):
    ...
    size = models.CharField(max_length=1L, blank=True)
    extent = models.CharField(max_length=1L, blank=True)
    solarsystemid = models.IntegerField(null=True, db_column='solarSystemID', blank=True) # Field name made lowercase.
    ...
    stationcount = models.IntegerField(null=True, db_column='stationCount', blank=True) # Field name made lowercase.
    stationsystemcount = models.IntegerField(null=True, db_column='stationSystemCount', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=4000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Crpnpcdivisions(models.Model):
    ...
    divisionname = models.CharField(max_length=100L, db_column='divisionName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    leadertype = models.CharField(max_length=100L, db_column='leaderType', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Crtcategories(models.Model):
    ...
    categoryname = models.CharField(max_length=256L, db_column='categoryName', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Crtclasses(models.Model):
    ...
    description = models.CharField(max_length=500L, blank=True)
    classname = models.CharField(max_length=256L, db_column='className', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
        db_table = 'crtClasses'
    def __unicode__(self):
...
class Dgmattributecategories(models.Model):
    categoryid = models.IntegerField(primary_key=True, db_column='categoryID') # Field name made lowercase.
    categoryname = models.CharField(max_length=50L, db_column='categoryName', blank=True) # Field name made lowercase.
    categorydescription = models.CharField(max_length=200L, db_column='categoryDescription', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Dgmattributetypes(models.Model):
    ...
    displayname = models.CharField(max_length=100L, db_column='displayName', blank=True) # Field name made lowercase.
...
class Dgmeffects(models.Model):
    ...
    effectname = models.CharField(max_length=400L, db_column='effectName', blank=True) # Field name made lowercase.
    ...
    description = models.CharField(max_length=1000L, blank=True)
    guid = models.CharField(max_length=60L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    ...
    sfxname = models.CharField(max_length=20L, db_column='sfxName', blank=True) # Field name made lowercase.
...
class Evegraphics(models.Model):
    ...
    graphicfile = models.CharField(max_length=500L, db_column='graphicFile') # Field name made lowercase.
    description = models.TextField()
    obsolete = models.IntegerField()
    graphictype = models.CharField(max_length=100L, db_column='graphicType', blank=True) # Field name made lowercase.
    ...
    graphicname = models.CharField(max_length=64L, db_column='graphicName') # Field name made lowercase.
    class Meta:
        managed = False
...
class Eveicons(models.Model):
    ...
    iconfile = models.CharField(max_length=500L, db_column='iconFile') # Field name made lowercase.
    description = models.TextField()
    class Meta:
        managed = False
        db_table = 'eveIcons'
...
class Eveunits(models.Model):
    ...
    unitname = models.CharField(max_length=100L, db_column='unitName', blank=True) # Field name made lowercase.
    displayname = models.CharField(max_length=50L, db_column='displayName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    class Meta:
        managed = False
        db_table = 'eveUnits'
...
class Invcategories(models.Model):
    categoryid = models.IntegerField(primary_key=True, db_column='categoryID') # Field name made lowercase.
    categoryname = models.CharField(max_length=100L, db_column='categoryName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=3000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    published = models.IntegerField(null=True, blank=True)
    class Meta:
        managed = False
...
class Invcontroltowerresourcepurposes(models.Model):
    ...
    purposetext = models.CharField(max_length=100L, db_column='purposeText', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Invflags(models.Model):
    ...
    flagname = models.CharField(max_length=200L, db_column='flagName', blank=True) # Field name made lowercase.
    flagtext = models.CharField(max_length=100L, db_column='flagText', blank=True) # Field name made lowercase.
...
class Invgroups(models.Model):
    ...
    categoryid = models.IntegerField(null=True, db_column='categoryID', blank=True) # Field name made lowercase.
    groupname = models.CharField(max_length=100L, db_column='groupName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=3000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
...
class Invmarketgroups(models.Model):
    ...
    marketgroupname = models.CharField(max_length=100L, db_column='marketGroupName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=3000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
...
class Invmetagroups(models.Model):
    ...
    metagroupname = models.CharField(max_length=100L, db_column='metaGroupName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    iconid = models.IntegerField(null=True, db_column='iconID', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Invnames(models.Model):
    itemid = models.BigIntegerField(primary_key=True, db_column='itemID') # Field name made lowercase.
    itemname = models.CharField(max_length=200L, db_column='itemName') # Field name made lowercase.
    class Meta:
        managed = False
        db_table = 'invNames'
    def __unicode__(self):
...
class Invtypes(models.Model):
    ...
    typename = models.CharField(max_length=100L, db_column='typeName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=3000L, blank=True)
...
class Invuniquenames(models.Model):
    ...
    itemname = models.CharField(max_length=200L, unique=True, db_column='itemName') # Field name made lowercase.
    groupid = models.IntegerField(null=True, db_column='groupID', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Mapcelestialstatistics(models.Model):
    ...
    spectralclass = models.CharField(max_length=10L, db_column='spectralClass', blank=True) # Field name made lowercase.
...
class Mapconstellations(models.Model):
    ...
    constellationname = models.CharField(max_length=100L, db_column='constellationName', blank=True) # Field name made lowercase.
...
class Mapdenormalize(models.Model):
    ...
    z = models.FloatField(null=True, blank=True)
    radius = models.FloatField(null=True, blank=True)
    itemname = models.CharField(max_length=100L, db_column='itemName', blank=True) # Field name made lowercase.
...
class Maplandmarks(models.Model):
    ...
    landmarkname = models.CharField(max_length=100L, db_column='landmarkName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=7000L, blank=True)
    locationid = models.IntegerField(null=True, db_column='locationID', blank=True) # Field name made lowercase.
    x = models.FloatField(null=True, blank=True)
    y = models.FloatField(null=True, blank=True)
    z = models.FloatField(null=True, blank=True)
...
class Mapregions(models.Model):
    ...
    regionname = models.CharField(max_length=100L, db_column='regionName', blank=True) # Field name made lowercase.
    x = models.FloatField(null=True, blank=True)
    y = models.FloatField(null=True, blank=True)
    z = models.FloatField(null=True, blank=True)
    xmin = models.FloatField(null=True, db_column='xMin', blank=True) # Field name made lowercase.
...
class Mapsolarsystems(models.Model):
    ...
    solarsystemname = models.CharField(max_length=100L, db_column='solarSystemName', blank=True) # Field name made lowercase.
    x = models.FloatField(null=True, blank=True)
    y = models.FloatField(null=True, blank=True)
    z = models.FloatField(null=True, blank=True)
    xmin = models.FloatField(null=True, db_column='xMin', blank=True) # Field name made lowercase.
    ...
    securityclass = models.CharField(max_length=2L, db_column='securityClass', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Mapuniverse(models.Model):
    ...
    universename = models.CharField(max_length=100L, db_column='universeName', blank=True) # Field name made lowercase.
    x = models.FloatField(null=True, blank=True)
    y = models.FloatField(null=True, blank=True)
    z = models.FloatField(null=True, blank=True)
    xmin = models.FloatField(null=True, db_column='xMin', blank=True) # Field name made lowercase.
...
class Planetschematics(models.Model):
    ...
    schematicname = models.CharField(max_length=255L, db_column='schematicName', blank=True) # Field name made lowercase.
...
class Ramactivities(models.Model):
    activityid = models.IntegerField(primary_key=True, db_column='activityID') # Field name made lowercase.
    activityname = models.CharField(max_length=100L, db_column='activityName', blank=True) # Field name made lowercase.
    iconno = models.CharField(max_length=5L, db_column='iconNo', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    published = models.IntegerField(null=True, blank=True)
    class Meta:
        managed = False
...
class Ramassemblylinetypes(models.Model):
    ...
    assemblylinetypename = models.CharField(max_length=100L, db_column='assemblyLineTypeName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
...
class Staoperations(models.Model):
    ...
    operationname = models.CharField(max_length=100L, db_column='operationName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    fringe = models.IntegerField(null=True, blank=True)
    corridor = models.IntegerField(null=True, blank=True)
    hub = models.IntegerField(null=True, blank=True)
...
class Staservices(models.Model):
    ...
    servicename = models.CharField(max_length=100L, db_column='serviceName', blank=True) # Field name made lowercase.
    description = models.CharField(max_length=1000L, blank=True)
    class Meta:
        managed = False
...
class Stastations(models.Model):
    ...
    constellationid = models.IntegerField(null=True, db_column='constellationID', blank=True) # Field name made lowercase.
    regionid = models.IntegerField(null=True, db_column='regionID', blank=True) # Field name made lowercase.
    stationname = models.CharField(max_length=100L, db_column='stationName', blank=True) # Field name made lowercase.
    x = models.FloatField(null=True, blank=True)
    y = models.FloatField(null=True, blank=True)
    z = models.FloatField(null=True, blank=True)
    reprocessingefficiency = models.FloatField(null=True, db_column='reprocessingEfficiency', blank=True) # Field name made lowercase.
...
class Translationtables(models.Model):
    sourcetable = models.CharField(max_length=200L, db_column='sourceTable') # Field name made lowercase.
    destinationtable = models.CharField(max_length=200L, db_column='destinationTable', blank=True) # Field name made lowercase.
    translatedkey = models.CharField(max_length=200L, db_column='translatedKey') # Field name made lowercase.
...
class Trntranslationcolumns(models.Model):
    ...
    tablename = models.CharField(max_length=256L, db_column='tableName') # Field name made lowercase.
    columnname = models.CharField(max_length=128L, db_column='columnName') # Field name made lowercase.
    masterid = models.CharField(max_length=128L, db_column='masterID', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Trntranslationlanguages(models.Model):
    ...
    languageid = models.CharField(max_length=50L, db_column='languageID', blank=True) # Field name made lowercase.
    languagename = models.CharField(max_length=200L, db_column='languageName', blank=True) # Field name made lowercase.
    class Meta:
        managed = False
...
class Trntranslations(models.Model):
    ...
    languageid = models.CharField(max_length=50L, db_column='languageID') # Field name made lowercase.
...
class Warcombatzones(models.Model):
    ...
    combatzonename = models.CharField(max_length=100L, db_column='combatZoneName', blank=True) # Field name made lowercase.
    factionid = models.IntegerField(null=True, db_column='factionID', blank=True) # Field name made lowercase.
